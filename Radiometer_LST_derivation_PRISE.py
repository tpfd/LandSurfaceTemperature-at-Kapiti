...
def main (**kwargs):
    ...
    df['Sky_wv'] = df['Sky_heitronic'].map(df_wv_H_sky.set_index('Temperature (K)')['Effective Wavelength (um)'].to_dict())
    ...
    print ('Heitronic uncert (med, max, min) :' + str(Heitronic_uncert_med), str(Heitronic_uncert_max), str(Heitronic_uncert_min))
